	...
	<section class="container mt-5 ">
            <div class="row justify-content-center">
                <div class="col-lg-3 sidbarprofil">
                    <div>
                        <img src="https://cdn.pixabay.com/photo/2015/04/22/15/01/portrait-734904_960_720.jpg" alt="photo de profil">
                    </div>
                    <div class="text-center mt-5">
                        <p class="text-8">Pierre MAVOUNGOU</p>
                        <p class="text-8">Numéro CNSS : <span class="color-span1">01010101</span></p>
                    </div>
                    <hr>
                    
                     <div class="text-center text-8 mt-3">
                ...
                <div class="col-lg-7 ">
                    <div class="informations">
                        ...
                        <div class="row p-4">
                            <div class="col-lg-6"><i class="far fa-calendar mr-3 imaurio"></i><span>Dierniere fonction </span><br><span class="color-span">Developpeur Web</span></div>
                            <div class="col-lg-6"><i class="fas fa-envelope mr-3 imaurio"></i><span>Adresse mail</span> <br><span class="color-span">pieremavoungou@gmail.com</span>  </div>
                        </div>
                        <div class="row p-4">
                    ...
                    <div class="informations mt-5">
                      <div class="informations1">
                        Faire une estimation de ma pension
                        </div>
                        <div>
